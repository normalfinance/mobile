  ...
  deposit: (
    {
      ...
      asset,
      token_b_amount
    }: { user: string; asset: string; token_b_amount: u128 },
    options?: {
      /**
  ...
  estimate_swap: (
    {
      ...
      direction,
      in_amount
    }: { asset: string; direction: SwapDirection; in_amount: u128 },
    options?: {
      /**
       * The fee to pay for the transaction. Default: BASE_FEE
       */
  ...
  withdraw: (
    {
      ...
      asset,
      share_amount
    }: { user: string; asset: string; share_amount: u128 },
    options?: {
      /**
       * The fee to pay for the transaction. Default: BASE_FEE
       */
...
export class Client extends ContractClient {
  ...
  public readonly fromJSON = {
    ...
    get_tokens_for_reward: this.txFromJSON<
      Map<string, readonly [boolean, u256]>
    >,
